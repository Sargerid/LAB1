...
public class PlayerController : MonoBehaviour
{
    ...
    public GameObject laserBeam, laserSpawner;
    ...
    void Update()
    {
        ...
        {
            GameObject goObj;
            goObj = Instantiate(laserBeam, laserSpawner.transform.position, laserSpawner.transform.rotation);
            goObj.transform.Rotate(new Vector3(0.0f, 0.0f, 90.0f));
